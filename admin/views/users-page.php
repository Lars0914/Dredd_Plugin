        ...
        <div class="management-redirect-panel">
            <div class="redirect-info">
                ...
                <div class="redirect-content">
                    ...
                    <p>Credit rates, package pricing, and economic settings have been centralized in the Payment page
                        for better organization and consistency.</p>
                    <div class="redirect-actions">
                        <a href="<?php echo admin_url('admin.php?page=dredd-ai-payments'); ?>"
                            class="epic-button primary">
                            <span class="button-icon">⚙️</span>
                            <span class="button-text">Manage Credit Settings</span>
                        </a>
                        <a href="<?php echo admin_url('admin.php?page=dredd-ai-payments#token-packages'); ?>"
                            class="epic-button secondary">
                            <span class="button-icon">📦</span>
                        ...
                        <?php else: ?>
                            <?php foreach ($users as $user): ?>
                                <tr class="user-row-epic" data-user-id="<?php echo $user->ID; ?>">
                                    ...
                                    <td class="analysis-stats-cell">
                                        <div class="stats-container">
                                            <div class="stat-row">
                                                ...
                                                <span
                                                    class="stat-value"><?php echo number_format($user->total_analyses ?? 0); ?></span>
                                                <span class="stat-label">Total</span>
                                            </div>
                                            <div class="stat-row">
                                                <span class="stat-icon">🔬</span>
                                                <span
                                                    class="stat-value"><?php echo number_format($user->standard_analyses ?? 0); ?></span>
                                                <span class="stat-label">Standard</span>
                                            </div>
                                            <div class="stat-row psycho">
                                                <span class="stat-icon">💀</span>
                                                <span
                                                    class="stat-value"><?php echo number_format($user->psycho_analyses ?? 0); ?></span>
                                                <span class="stat-label">Psycho</span>
                                            </div>
                                            <div class="stat-row danger">
                                                <span class="stat-icon">🚨</span>
                                                <span
                                                    class="stat-value"><?php echo number_format($user->scams_detected ?? 0); ?></span>
                                    ...
                                    <td class="date-cell">
                                        <div class="date-display">
                                            <div class="date-main"><?php echo date('M j, Y', strtotime($user->created_at)); ?>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
...
<style>
    ...
    @keyframes statusPulse {
        ...
        50% {
            box-shadow: 0 0 0 4px rgba(64, 224, 208, 0);
        }
    }
