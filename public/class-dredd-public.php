...
class Dredd_Public {
    ...
    public function render_chat_interface($atts) {
        ...
        <div class="dredd-chat-wrapper" data-session="<?php echo esc_attr($session_id); ?>">
            <!-- Chat Container -->
            <div class="dredd-chat-container" style="width: <?php echo esc_attr($atts['width']); ?>; height: <?php echo esc_attr($atts['height']); ?>;">
                                ...
                                <div class="payment-method-section">
                                    ...
                                    <div class="payment-method-card stripe-card" data-method="stripe">
                                        <div class="card-logos">
                                            <img src="<?php echo DREDD_AI_PLUGIN_URL; ?>assets/images/visa.svg" alt="Visa" class="card-logo">
                                            <img src="<?php echo DREDD_AI_PLUGIN_URL; ?>assets/images/mastercard.svg" alt="Mastercard" class="card-logo">
                                            <img src="<?php echo DREDD_AI_PLUGIN_URL; ?>assets/images/amex.svg" alt="American Express" class="card-logo">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="payment-step" id="payment-step-3">
                            ...
                            <div class="payment-modal-content">
                                ...
                                <div class="payment-form pulsechain-form" id="pulsechain-payment-form" style="display: none;">
                                    ...
                                    <button class="payment-submit-btn" id="pulsechain-submit-btn" style="display: none;">Send Payment</button>
                                </div>
                                ...
                                <form id="dredd-login-form" class="auth-form-inner">
                                    ...
                                    <div class="form-group captcha-group">
                                        ...
                                        <div class="captcha-fallback" style="display: none;">
                                            <label for="login-captcha">Security Check: What is <?php echo rand(1,9); ?> + <?php echo rand(1,9); ?>?</label>
                        ...
                        <div class="auth-form signup-form" id="signup-form">
                            ...
                            <div class="auth-modal-content">
                                ...
                                <form id="dredd-signup-form" class="auth-form-inner">
                                    ...
                                    <!-- reCAPTCHA -->
                                    <div class="form-group captcha-group">
                                        <div id="signup-recaptcha" class="g-recaptcha" data-sitekey="<?php echo esc_attr(dredd_ai_get_option('recaptcha_site_key', '')); ?>" data-theme="dark"></div>
                                        <div class="captcha-fallback" style="display: none;">
                                            <label for="signup-captcha">Security Check: What is <?php echo rand(1,9); ?> + <?php echo rand(1,9); ?>?</label>
        ...
        <div class="dredd-user-dashboard">
            ...
            <div class="dashboard-header">
                ...
                <div class="dashboard-status">
                    <span class="account-type"><?php echo $user_data['tokens']->token_balance > 0 ? 'PREMIUM' : 'FREE'; ?> CITIZEN</span>
                </div>
            </div>
                            ...
                            <tr>
                                <td>
                                    <div class="token-info">
                                        ...
                                        <code class="contract-short"><?php echo esc_html(substr($analysis->contract_address, 0, 10) . '...'); ?></code>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <button class="reanalyze-token" data-contract="<?php echo $analysis->contract_address; ?>" data-chain="<?php echo $analysis->chain; ?>">Re-analyze</button>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="status-badge <?php echo $transaction->status; ?>"><?php echo ucfirst($transaction->status); ?></span></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
        ...
        <div class="promoted-tokens">
            ...
            <div class="promotion-card" data-promotion-id="<?php echo $promotion->id; ?>">
                <div class="promotion-header">
                    ...
                    <img src="<?php echo esc_url($promotion->token_logo); ?>" alt="<?php echo esc_attr($promotion->token_name); ?>" class="token-logo" />
                    <?php endif; ?>
                    <div class="token-info">
                ...
                <div class="promotion-actions">
                    ...
                    <button class="analyze-promoted" data-contract="<?php echo esc_attr($promotion->contract_address); ?>" data-chain="<?php echo esc_attr($promotion->chain); ?>">
                        ⚡ ANALYZE NOW
                    </button>
                    <?php endif; ?>
